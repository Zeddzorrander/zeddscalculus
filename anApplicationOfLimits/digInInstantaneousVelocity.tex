...
ball at $t=0$, is
\begin{explanation}
 \wordChoice{\choice{A}\choice[correct]{B}\choice{C}\choice{D}}.
\end{explanation}
\item The point that corresponds to $s(1)$, the position (height) of the 
ball at $t=1$, is
\begin{explanation}
 \wordChoice{\choice{A}\choice{B}\choice{C}\choice[correct]{D}}.
\end{explanation}
\item The point that corresponds to $s(2)$, the position (height) of the 
ball at $t=2$, is
\begin{explanation}
 \wordChoice{\choice{A}\choice{B}\choice[correct]{C}\choice{D}}.
\end{explanation}
\end{enumerate}
