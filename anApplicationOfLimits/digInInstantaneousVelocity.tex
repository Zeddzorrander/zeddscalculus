...
\[
s(2) = 40\cdot\answer{2} - 16\cdot\answer{2}^2 = 
\answer{16}\text{ft}
\]
...
\[
v_{\text{av}} =\answer{8-16t}\hspace{0.06in}\text{ft/s}.
\]
\end{explanation}
...
\item $[2, 2.1]$
\[
v_{\text{av}} =  8-16(\answer{2.1})=-25.6 \hspace{0.06in}\text{ft/s}
\]
\item $[1.9,2]$
\[
v_{\text{av}} =  8-16(\answer{1.9})=-22.4 \hspace{0.06in}\text{ft/s}
\]
\end{enumerate}
\end{enumerate}
\end{example}
