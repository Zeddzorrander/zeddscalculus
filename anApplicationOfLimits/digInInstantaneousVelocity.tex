...
\[
v_{\text{av}} =\answer[given]{8-16t}\hspace{0.06in}ft/s.
\]
\end{explanation}
...
\item $[2, 2.1]$
\[
v_{\text{av}} =  8-16(\answer[given]{2.1})=-25.6 \hspace{0.06in}ft/s
\]
\item $[1.9,2]$
\[
v_{\text{av}} =  8-16(\answer[given]{1.9})=-22.4 \hspace{0.06in}ft/s
\]
\end{enumerate}
\end{enumerate}
\end{example}
...
\[
v_{\text{av}} =  \frac{s(t)-s(2)}{t-2}= 8-16t \hspace{0.06in}ft/s.
\]
