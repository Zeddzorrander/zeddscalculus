...
\begin{example}
  ...
  \begin{explanation}
  	 The slope of the tangent line to the graph of the function $f(x) + g(x)$ at $x = 2$ is the derivative $ \left[\frac{d}{dx} \left(f(x)+g(x)\right)\right]_{x=2}$. By the Sum Rule, this derivative is given by $f'(2) + g'(2)$.   In 
