...
\begin{example}
  ...
  \begin{explanation}
  	 The slope of the tangent line to the curve  $y=\frac{f(x)}{g(x)}$ at $x = 4$ is given by $ \left[\frac{d}{dx}\frac{f(x)}{g(x)}\right]_{x=4}$.
	 
	  By the QuotientRule, this derivative is given by 
	 \begin{align*}
\left[\frac{d}{dx}\frac{f(x)}{g(x)}\right]_{x=4} &=\left[\frac{f'(x)g(x)-f(x)g'(x)}{\left(g(x)\right)^2}\right]_{x=4}\\
...
\begin{example}
  ...
  \begin{explanation}
  	 The slope of the tangent line to the curve  $y=\frac{xf(x)}{g(x)}$ at $x = 4$ is given by $ \left[\frac{d}{dx}\frac{xf(x)}{g(x)}\right]_{x=4}$.
	 
	  By the QuotientRule and the Product Rule, this derivative is given by 
	 \begin{align*}
\left[\frac{d}{dx}\frac{xf(x)}{g(x)}\right]_{x=4} &=\left[\frac{(xf'(x)+f(x))g(x)-xf(x)g'(x)}{\left(g(x)\right)^2}\right]_{x=4}\\
