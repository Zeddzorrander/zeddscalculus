    ...
    \begin{image}
      \begin{tikzpicture}
        \begin{polaraxis}[
          ...
          %\addplot+[draw=none,very thick, mark=none,fill=fill1,domain=45:225,samples=100,smooth] {1+cos(x)} \closedcycle;
          %\addplot+[draw=none,very thick, mark=none,fill=white,domain=0:45,samples=100,smooth] {pi/4*sec(x)} \closedcycle;
          %\addplot+[draw=none,very thick, mark=none,fill=fill1,domain=-135:45,samples=100,smooth] {1+sin(x)}\closedcycle;
