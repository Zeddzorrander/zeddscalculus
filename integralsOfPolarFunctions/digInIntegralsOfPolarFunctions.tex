    ...
    \begin{image}
      \begin{tikzpicture}
        \begin{polaraxis}[
          ...
          \addplot+[draw=none,very thick, mark=none,fill=fill1,domain=45:225,smooth] {1+cos(x)} \closedcycle;
          \addplot+[draw=none,very thick, mark=none,fill=white,domain=-115:45,samples=100,smooth] {1+sin(x)}\closedcycle;
